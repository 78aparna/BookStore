...
function Auth({insideRegister}) {
  ...
  return (
    ...
    bg-center'>
      <div className="p-10">
        <h1 className="text-3xl font-bold text-white text">BOOK STORE</h1>
          ...
          <div style={{width:'100px',height:'100px',borderRadius:'50%'}} className="border mb-5 flex justify-center items-center">
            ...
            <form className="my-5 w-full">
              ...
              <div className="my-5 text-center">
                {
                  insideRegister ?
                  <p className="text-blue-600">Already a User? <Link to={'/login'} className='underline 
                  ms-5'>Login</Link></p>
                  :
                  <p className="text-blue-600">Are a new User? <Link to={'/register'} className='underline 
                  ms-5'>Register</Link></p>
                }
              </div>
