...
I enjoy fiction, self-development, and history books. This bookstore helps me organize my reading journey, follow my favorite authors, and receive recommendations based on what I love. I believe every book brings a new perspective, and I'm here to explore them all.
    ...
    <div className="md:px-40">
      ...
      <div className="flex justify-center items-center my-8 font-medium text-lg">
        <p onClick={()=>setTab(1)} className={tab==1?"text-blue-600 border-gray-200 border-t border-1 border-r p-4 cursor-pointer":
          " border-gray-200 border-b p-4 cursor-pointer"
        }>Sell Books</p>
        <p onClick={()=>setTab(2)} className={tab==2?"text-blue-600 border-gray-200 border-t border-1 border-r p-4 cursor-pointer":
          " border-gray-200 border-b p-4 cursor-pointer"
        }>Book Status</p>
        <p onClick={()=>setTab(3)} className={tab==3?"text-blue-600 border-gray-200 border-t border-1 border-r p-4 cursor-pointer":
          " border-gray-200 border-b p-4 cursor-pointer"
        }>Purchase History</p>
