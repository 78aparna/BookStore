...
import {Legend, XAxis, YAxis, CartesianGrid, Tooltip, Bar, ResponsiveContainer, BarChart,PieChart, Pie  } from 'recharts'
     ...
     <div className="md:grid grid-cols-5">
      ...
      <div className="col-span-4 p-10">
        ...
        <div className="md:grid grid-cols-2 mt-10">
          <h3 className="text-xl font-bold">Monthliy Reveniew(Bar Chart)</h3>
          <h3 className="text-xl font-bold">Monthliy Purchase Analysis(Bar Chart)</h3>
